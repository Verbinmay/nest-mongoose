...
var CommentsController = /** @class */ (function () {
    function CommentsController(commentService, jwtService) {
        this.commentService = commentService;
        this.jwtService = jwtService;
    }
    CommentsController.prototype.findById = function (id, tokens) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        userId = _a.sent();
                        return [2 /*return*/, this.commentService.findById(id, userId)];
                }
            });
        });
    };
    ...
    ], CommentsController.prototype, "findById");
